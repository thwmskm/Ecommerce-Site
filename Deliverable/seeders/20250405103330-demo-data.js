      ...
      [
        {
          ...
          inFabric: "Leather",
          imageUrl:
            "https://media.ed.edmunds-media.com/ford/mustang/2022/oem/2022_ford_mustang_coupe_ecoboost-premium_fq_oem_1_815x543.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          description:
            "A muscle car offering powerful performance and iconic style.",
          brand: "Chevrolet",
          model: "Camaro",
          modelYear: 2020,
          shape: "Coupe",
          ...
          inFabric: "Leather",
          imageUrl:
            "https://media.ed.edmunds-media.com/chevrolet/camaro/2020/oem/2020_chevrolet_camaro_convertible_1ss_fq_oem_1_815x543.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          name: "BMW X5",
          description:
            "A luxury SUV with advanced technology and excellent performance.",
          brand: "BMW",
          model: "X5",
          modelYear: 2021,
          shape: "SUV",
          ...
          inFabric: "Synthetic",
          imageUrl:
            "https://media.ed.edmunds-media.com/bmw/x5/2021/oem/2021_bmw_x5_4dr-suv_xdrive45e_fq_oem_1_815x543.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          inFabric: "Fabric",
          imageUrl:
            "https://media.ed.edmunds-media.com/jeep/wrangler/2023/oem/2023_jeep_wrangler_convertible-suv_willys_fq_oem_3_815x543.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ],
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          name: "Camera System",
          description:
            "A 360-degree camera system for easier parking and safety.",
          priceAdjustment: 1500.0,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          name: "Premium Audio",
          description:
            "High-quality sound system for an enhanced audio experience.",
          priceAdjustment: 2800.0,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
        ...
        },
        {
          ...
          description:
            "A digital display on the windshield for key vehicle info.",
          priceAdjustment: 4500.0,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
