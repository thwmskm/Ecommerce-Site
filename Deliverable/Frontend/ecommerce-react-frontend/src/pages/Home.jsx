...
function Home() {
  ...
  const [metadata, setMetadata] = useState({ brands: [], shapes: [], years: [] });
    ...
    <div>
      ...
      <div className="catalog-container">
        ...
        <div className="filter-panel">
            ...
            <select name="accidents" id="accidents" onChange={handleFilterChange}>
            ...
            <select name="hotDeals" id="hotDeals" onChange={handleFilterChange}>
            ...
            <select name="sortOrder" id="sortOrder" onChange={handleFilterChange}>
                <option value="">Default</option>
        ...
        vehicles.map((vehicle) => {
            ...
            <div key={vehicle.vid} className="vehicle-card">
                <div className="vehicle-image">
                    ...
                    <div className="info-column">
                        <p><strong>Accidents:</strong> {vehicle.hasAccidents ? 'Yes' : 'No'}</p>
                    ...
                    <div className="card-buttons">
                        <Link className="card-button" to={`/vehicle/${vehicle.vid}`}>
                        View Details
                        </Link>
                        <button
